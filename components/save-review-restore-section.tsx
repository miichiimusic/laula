...
const features: FeatureData[] = [
  {
    id: "save",
    title: "Save",
    description: "Your site is always backed up — every change is restorable.",
  ...
  },
  {
    id: "preview",
    title: "Preview",
    description: "See every update live before it goes public.",
  ...
  },
  {
    id: "restore",
    title: "Restore",
    description: "We can go back to any previous version, no stress, no downtime.",
  ...
  return (
    <div className="my-24">
      ...
      <div className="text-center mb-6 md:mb-12 px-4">
        ...
        >
          {
            "We build your website first, no commitment needed. Preview it live, request edits, and once you’re ready, we launch it under your domain."
          }
        </p>
      </div>
              ...
              <div className="absolute inset-0 hidden lg:flex flex-col justify-end p-6 lg:p-8">
                ...
                <div className="flex gap-4 lg:gap-8 items-end">
                  ...
                  <div className="flex-1 max-w-xs lg:max-w-md">
                    ...
                    {onOpenInstall && (
                      <Button
                        onClick={() => onOpenInstall("get-started")} // This will use the default "get-started" tab from app/page.tsx
